...
public class ScraperThread implements Runnable {
  ...
  // TODO: constructor
  public ScraperThread(Website website, ThreadListener listener, String prefix, String year, int suffixFirst,
      int suffixLast) {
  ...
  public void run() {
    ...
    for (int i = suffixFirst; i <= suffixLast; i++) {
      ...
      Student stud = this.website.getStudentDataByNIM(nim);
      res.add(stud);
    }
